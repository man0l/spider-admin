...
class AmazonItemController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        $sql = "
                SELECT ai.*, i.upc as upc, i.title as ebay_title, i.ebay_id, count(distinct iis.id) AS sold, group_concat(DISTINCT REPLACE(aii.path, 'full/', '')) AS images_list, ROUND((i.price - (i.price * 0.144) - 0.3) - ai.price, 2) AS profit
                FROM amazon_item ai
